...
///			
///			<insertComponent id="arches_arcgispro_addin_Custom_ResourceHandler" 
///			                 className="arches_arcgispro_addin.Custom.ImageResourceSchemeHandler">
///				<content SchemeName="resource"/>
///			</insertComponent>
///
///			<insertComponent id="arches_arcgispro_addin_Custom_ResourceHandler2" 
///			                 className="arches_arcgispro_addin.Custom.EmbeddedResourceSchemeHandler">
...
/// </code>
/// </example>
namespace arches_arcgispro_addin.Custom
{
	/// <summary>
